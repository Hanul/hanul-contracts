...
interface INonFungibleTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class INonFungibleToken extends Contract {
  ...
  interface: INonFungibleTokenInterface;
