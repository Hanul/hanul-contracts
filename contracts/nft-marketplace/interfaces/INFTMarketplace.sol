...
interface INFTMarketplace {
    ...
    function buy(INonFungibleToken nft, uint256 nftId) payable external;
    function cancelSale(INonFungibleToken nft, uint256 nftId) external;

    function offer(INonFungibleToken nft, uint256 nftId) payable external returns (uint256 offerId);
    ...
    function bid(INonFungibleToken nft, uint256 nftId) payable external returns (uint256 biddingId);
